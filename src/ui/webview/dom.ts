...
export const voiceActivity = document.getElementById("voiceActivity") as HTMLElement;
export const voiceActivityLabel = document.getElementById("voiceActivityLabel") as HTMLElement;
export const voiceMeter = document.getElementById("voiceMeter") as HTMLElement;
export const voiceLevel = document.getElementById("voiceLevel") as HTMLElement;
...
export const composerBlockedNotice = document.getElementById(
