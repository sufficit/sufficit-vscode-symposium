...
export const ICONS: Record<string, string> = {
    terminal:
        "M2 2.5A1.5 1.5 0 0 1 3.5 1h9A1.5 1.5 0 0 1 14 2.5v11a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5v-11Zm2.3 2.2 2.5 2.3-2.5 2.3.7.7 3.2-3-3.2-3-.7.7ZM8 10h4v1H8v-1Z",
    ...
    history:
        "M8 2a6 6 0 1 0 4.24 1.76l-.7.7A5 5 0 1 1 8 3a4.98 4.98 0 0 1 3.54 1.46L9.5 6.5H14V2l-1.76 1.76A5.96 5.96 0 0 0 8 2Zm-.5 3h1v3.2l2.2 1.3-.5.86L7.5 8.75V5Z",
    ...
    warning:
        "M7.1 2.2a1 1 0 0 1 1.8 0l6 10.5A1 1 0 0 1 14 14H2a1 1 0 0 1-.9-1.3l6-10.5ZM8 3 2.2 13h11.6L8 3Zm-.6 3h1.2v3.8H7.4V6Zm0 5h1.2v1.2H7.4V11Z",
    ...
    circleEmpty:
        "M8 2a6 6 0 1 0 0 12A6 6 0 0 0 8 2Zm0 1.3A4.7 4.7 0 1 1 8 12.7 4.7 4.7 0 0 1 8 3.3Z",
...
const FILE_ICONS: Record<string, { i: string; c: string }> = {
    ts: { i: "code", c: "#3178c6" },
    tsx: { i: "code", c: "#3178c6" },
    js: { i: "code", c: "#e8c020" },
    jsx: { i: "code", c: "#e8c020" },
    ...
    md: { i: "mdfile", c: "#519aba" },
    markdown: { i: "mdfile", c: "#519aba" },
    css: { i: "code", c: "#519aba" },
    scss: { i: "code", c: "#c6538c" },
    less: { i: "code", c: "#519aba" },
    html: { i: "code", c: "#e37933" },
    vue: { i: "code", c: "#41b883" },
    svelte: { i: "code", c: "#ff3e00" },
    py: { i: "code", c: "#3572A5" },
    rs: { i: "code", c: "#dea584" },
    go: { i: "code", c: "#00ADD8" },
    java: { i: "code", c: "#b07219" },
    c: { i: "code", c: "#555555" },
    cpp: { i: "code", c: "#f34b7d" },
    cs: { i: "code", c: "#178600" },
    sh: { i: "code", c: "#89e051" },
    yml: { i: "braces", c: "#cb171e" },
    yaml: { i: "braces", c: "#cb171e" },
    toml: { i: "braces", c: "#9c4221" },
    png: { i: "image", c: "#a074c4" },
    jpg: { i: "image", c: "#a074c4" },
    jpeg: { i: "image", c: "#a074c4" },
    gif: { i: "image", c: "#a074c4" },
    svg: { i: "image", c: "#ffb13b" },
    webp: { i: "image", c: "#a074c4" },
};
export function fileIcon(name: string): { i: string; c: string } {
