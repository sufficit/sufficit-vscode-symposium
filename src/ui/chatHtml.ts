 ...
 *
 * Styles live in ./chatStyles, client script in ./chatClient; this file owns
 * the document shell + body markup and composes the three.
 */
...
<div id="ctxMenu"></div>
<script nonce="${nonce}">${chatClientJs}</script>
</body>
</html>`;
}
