        ...
        <div id="composer">
            ...
            <div id="toolbar">
                ...
                <div id="sendGroup">
                    ...
                    <button id="micPause" title="Pausar gravação" aria-label="Pausar gravação" style="display:none"><svg viewBox="0 0 16 16" fill="currentColor"><rect x="4" y="3" width="3" height="10" rx="1"/><rect x="9" y="3" width="3" height="10" rx="1"/></svg></button>
